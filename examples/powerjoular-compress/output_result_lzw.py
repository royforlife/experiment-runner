...
base_directory_pattern = "~/green-lab/experiment-runner/examples/powerjoular-compress/experiments/lzw_formal*"
        ...
        if dir_name.startswith("run_"):
            ...
            if len(files) == 1:
                ...
                if os.path.exists(csv_file_path):
                    ...
                    extracted_data["algo-format-size-repetation"] = f"lzw-{file_name}"
                    # make algo-format-size-repetation be the first column
                    # get second row
...
result_df.to_csv("output_result_lzw_all.csv", index=True)
# import pdb; pdb.set_trace()
